...
class AppSettings {
  ...
  AppSettings({
    this.themeColor = AppThemeColor.linenTeal,
  ...
  Map<String, dynamic> toMap() =>
      {'themeColor': themeColor.name, 'languageCode': languageCode};
